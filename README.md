...
## Baixando E Instalando O Projeto Angular
Primeiramente tenha configurado em sua máquina a API do Projeto (https://github.com/FelipeDuarte21/sistema_controle_financeiro-back_end-API-spring), em seguinda certifique-se de ter instalado o angular em sua máquina. Clone este repositório em algum lugar na sua máquina, entre na pasta do projeto pelo terminal e execute o seguinte comando "npm install" este comando vai baixar todas as dependências do projeto, em seguida execute o comando "ng serve --open" este comando é para rodar o projeto localmente (Obs: a API do Projeto deve está rodando na sua máquina).
